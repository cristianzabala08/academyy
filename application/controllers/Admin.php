...
class Admin extends CI_Controller {
  ...
  public function user_form($param1 = "", $param2 = "",$parme3="") {
    if ($this->session->userdata('admin_login') != true) {
      redirect(site_url('login'), 'refresh');
    }
    ...
    elseif ($param1 == 'edit_user_form') {
      ...
      $this->load->view('backend/index', $page_data);
    }elseif ($param1 == 'details_user') {
      $page_data['page_name'] = 'user_details';
      $page_data['user_id'] = $param2;
      $page_data['page_title'] = get_phrase('user_details');
      $this->load->view('backend/index', $page_data);
    }elseif ($param1 == 'details_curso') {
      $page_data['page_name'] = 'curso_details';
      $page_data['user_id'] = $param2;
      $page_data['curso_id'] = $parme3;
      $page_data['page_title'] = get_phrase('user_details');
      $this->load->view('backend/index', $page_data);
    }
  }
