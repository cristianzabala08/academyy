...
class User_model extends CI_Model {
    ...
    public function my_quiz($user_id = "") {
        if ($user_id == "") {
            $user_id = $this->session->userdata('user_id');
        }
        return $this->db->get_where('quiz', array('id_user' => $user_id));
    }
    public function my_quiz_curso($user_id = "", $curso =" ") {
        if ($user_id == "") {
            $user_id = $this->session->userdata('user_id');
        }
        return $this->db->get_where('quiz', array('id_user' => $user_id , 'id_curso' =>$curso));
    }
