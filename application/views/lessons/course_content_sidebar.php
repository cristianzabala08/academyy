                      ...
                      <?php foreach ($lessons as $key => $lesson): ?>
                        ...
                        <tr style="width: 100%; padding: 5px 0px;background-color: <?php if ($lesson_id == $lesson['id'])echo '#E6F2F5'; else echo '#fff';?>;">
                          <td style="text-align: left; padding:7px 10px;">
                            ...
                            <div class="form-group" id="Comunt">
                              <input type="checkbox" id="<?php echo $lesson['id']; ?>"  onchange="markThisLessonAsCompleted(this.id, tp='<?php echo $lesson['lesson_type']; ?>');" value = 1 <?php if($lesson_progress == 1):?> checked <?php endif; ?>>
