<?php $my_courses = $this->user_model->my_courses()->result_array();   ?>
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                              ...
                              <td>
                                  <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo site_url('admin/user_form/details_user/'.$user['id']) ?>"><?php echo get_phrase('user_details'); ?></a></li>
